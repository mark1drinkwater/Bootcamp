``SELECT geo_name,
	...
	WHERE p0010001 >= (SELECT percentile_cont(.9) WITHIN GROUP (ORDER BY p0010001) FROM us_counties_2010)
...
CREATE TABLE retirees (id int);
INSERT INTO retirees VALUES (1), (2);
...
FROM 'C:\Users\Mark\Desktop\postrgesql\practical-sql-main\Chapter_12\ice_cream_survey.csv'
...
FROM 'C:\Users\Mark\Desktop\postrgesql\practical-sql-main\Chapter_12\temperature_readings.csv'
WITH (FORMAT CSV, HEADER);
...
SELECT max_temperature_group, COUNT(*)
FROM temps_collapsed
GROUP BY max_temperature_group
ORDER BY COUNT(*) DESC;
-- 86-87 is the largest group
...
-- Modified flavour to be rows instead of columns
-- basically replaced flavour with office and vice-versa
SELECT *
