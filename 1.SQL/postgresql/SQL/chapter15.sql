...
SELECT percent_change(300, 100, 2);

SELECT c2010.geo_name,
	c2010.state_us_abbreviation AS st,
	c2010.p0010001 AS pop_2010,
	percent_change(c2010.p0010001, c2000.p0010001) AS pct_chg_func, --new way
	round( (CAST(c2010.p0010001 AS numeric(8,1)) - c2000.p0010001) -- old way
...
UPDATE teachers SET hire_date = '2017-10-30'::date
WHERE id=1;
...
SELECT rates_per_thousand(5, 500);
...
INSERT INTO meat_poultry_egg_inspect (est_number, company, street, city, st, zip, phone, grant_date, activities, dbas, zip_copy, reviewed_date, meat_processing, poultry_processing)
VALUES('M96321+P94572', 'Nandos Inc', '10a Victoria Rd', 'Johannesburg', 'CA', '2094', '(011) 216 3300', '2023-02-21', 'Poultry Processing', 'Nandos South Afirca', '02904', '2022-02-21', false, true);

SELECT est_number, company, inspection_date
FROM meat_poultry_egg_inspect
WHERE est_number = 'M96321+P94572'; 
