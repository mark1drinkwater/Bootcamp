    ...
    public static void main(String[] args) {
        do {
            ...
            try {
                ...
                LocalDate nextBD = birthDate.plusYears(years +1);
                System.out.println("Your next birthday is " + nextBD.format(fullFormat));

                long wait = LocalDate.now().until(nextBD, ChronoUnit.DAYS);
