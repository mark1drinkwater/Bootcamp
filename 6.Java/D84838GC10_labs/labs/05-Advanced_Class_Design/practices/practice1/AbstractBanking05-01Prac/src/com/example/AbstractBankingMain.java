...
// Create several customers and their accounts
        ...
        customer.addAccount(new CheckingAccount(200.0, 400.00));
        ...
        CheckingAccount chkAcct = new CheckingAccount(100.00, 200.00);
        customer.addAccount(chkAcct);
        
        if (chkAcct.withdraw(250.00)) {
            customer.addAccount(chkAcct);
            System.out.print(" Withdraw is successful R" + 
                    chkAcct.getBalance() );
        } else {
            System.out.print(" withdraw was unsuccessful.");
        }
