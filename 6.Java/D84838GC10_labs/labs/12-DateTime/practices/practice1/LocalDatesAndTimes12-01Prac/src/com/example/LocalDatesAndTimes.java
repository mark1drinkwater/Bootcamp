...
public class LocalDatesAndTimes {
  ...
  public static void main(String[] args) {
    ...
    long abeYears = YEARS.between(abeBirth, abeDeath);
    long abeDays = DAYS.between(abeBirth, abeDeath);
    System.out.println("Abe was " + abeYears + " when he died.");
    System.out.println("Abe lived for 16863 days.");
    ...
    System.out.println("Days in the year he was born: " + benBorn.getDayOfYear());
    Long decades = DECADES.between(benBorn, LocalDate.now());
    System.out.println("Bennedict is " + decades + " old.");
    
    DayOfWeek ben21Birth = benBorn.plusYears(21).getDayOfWeek();
    System.out.println("It was a " + ben21Birth + " on his 21st birthday.");
    ...
    LocalTime ny = LocalTime.of(19, 25);
    System.out.println("Planned Travel time: " + MINUTES.between(boston, ny) + " minutes.");
      System.out.println("Delayed arrival time: " + ny.plusHours(1) );      
    ...
    LocalDateTime flightDepart = LocalDateTime.of(2014, MARCH, 25, 1, 30);
    LocalDateTime flightArrive = flightDepart.plusHours(4).plusMinutes(15);
            
    System.out.println("The flight arrives in Miami: " + flightArrive);
    System.out.println("The delayed arrival time is: " + flightArrive.plusHours(4).plusMinutes(27));
