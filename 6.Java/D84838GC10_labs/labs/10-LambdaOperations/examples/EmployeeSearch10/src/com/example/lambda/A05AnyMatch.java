...
public class A05AnyMatch {
    ...
    public static void main(String[] args) {
      ...
      // anyMatch returns a boolean based on the specified Predicate.
      // This is a short-circuiting terminal operation
      // This example shows how anyMatch could be used to check for 
      // a value before executing a more detailed query.
