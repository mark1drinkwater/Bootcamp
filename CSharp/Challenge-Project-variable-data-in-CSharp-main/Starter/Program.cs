    ...
    switch (menuSelection)
    {
        ...
        case "2":
            ...
            while (dogCharacteristics.Length == 0)
            {
                ...
                Console.WriteLine($"\r\nEnter one or more desired dog characteristic(s) to search for");
                readResult = Console.ReadLine();
                if (readResult != null)
                {
            ...
            if (noMatchesDog)
            {
                Console.WriteLine("None of our dogs are a match for: " + string.Join(", ", dogCharacteristics) );
            }
