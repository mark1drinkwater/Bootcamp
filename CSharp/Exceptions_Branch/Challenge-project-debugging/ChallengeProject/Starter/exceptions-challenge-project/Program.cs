...
{
    // Fix: Instead of directly affecting the till
    // We first copy the bill count into a separate bill sheet
    // So that if we don't have enough change, we don't deduct those bills.
